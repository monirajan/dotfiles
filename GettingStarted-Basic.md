...
```zsh
export GH_USERNAME="monirajan" DOTFILES_BRANCH="master" HOMEBREW_BASE_INSTALL="true"; curl --retry 3 --retry-delay 5 --retry-all-errors -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh; unset HOMEBREW_BASE_INSTALL
```
